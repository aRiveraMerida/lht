...
export const metadata: Metadata = {
  ...
  description: 'Política de privacidad de La Habitación Tortuga. Información sobre el tratamiento de datos personales.',
};

export default function PoliticaPrivacidad() {
  return (
    <div className="px-4 py-16 md:px-8 md:py-20 max-w-[700px] mx-auto">
      <h1 className="text-3xl font-semibold tracking-[-0.04em] text-text mb-4 md:text-4xl">Política de Privacidad</h1>
      ...
      <div className="space-y-8 text-[15px] text-text/80 leading-7">
        <div>
          <h2 className="text-xl font-semibold text-text mb-2">1. Responsable</h2>
          <p>Alberto Rivera Mérida — hola@lahabitaciontortuga.com</p>
        </div>

        <div>
          <h2 className="text-xl font-semibold text-text mb-2">2. Datos recogidos</h2>
          <p>Dirección de email.</p>
        </div>

        <div>
          <h2 className="text-xl font-semibold text-text mb-2">3. Finalidad</h2>
          <p>Envío de newsletter &ldquo;La Habitación Tortuga&rdquo;.</p>
        </div>

        <div>
          <h2 className="text-xl font-semibold text-text mb-2">4. Base jurídica</h2>
          <p>Consentimiento explícito (Art. 6.1.a RGPD).</p>
        </div>

        <div>
          <h2 className="text-xl font-semibold text-text mb-2">5. Conservación</h2>
          <p>Mientras dure la suscripción. Tras baja, eliminación en 30 días.</p>
        </div>

        <div>
          <h2 className="text-xl font-semibold text-text mb-2">6. Destinatarios</h2>
          <p>
        ...
        <div>
          <h2 className="text-xl font-semibold text-text mb-2">7. Derechos</h2>
          <p>
